...
// Definimos el tiempo de validez del token en segundos. Mientras estemos en fase dedesarrollo
// podemos definir tiempos largos para que no nos den problema la caducidad deltoken.
...
// Método que genera un token. Este método debe recibir toda la información quequeremos
// que quede almacenada en el token, en nuestro caso vamos a guardar el username, elemaily el role
 ...
 // Construimos el token con el nombre del usuario, la fecha de expiración, lainformación
 ...
 // Al token generado le podemos añadir alguna información para que luego compruebaque
